...
remove(CO2data,NOdata,tonedata)
...
#caricare nuovamente il dataset per ripristinare i valori di partenza

remove(NOdata,CO2data, tonedata)

# FINE ANALISI DESCRITTIVA -----------------------------------------------------------



#GRAFICO SILHOUETTE PER DETERMINARE IL MIGLIOR NUMERO DI CLUSTER
...
set.seed(1111)
NbClust(MMD, distance="euclidean", method="ward.D2") 
...
MixtureModel1$parameters$pro #probabilità che le osservazioni di ogni variabile si trovino nel primo e nel secondo cluster
